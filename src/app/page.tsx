 ...
 *
 * Deliberately not a product screen (agents.md §10.0: "Zero product features"). Its only job
 * is to prove, visibly and in a test, that the generated design tokens reach the browser:
 * every colour, radius, shadow, size and weight below comes from src/styles/tokens.css.
 * There is not a single raw hex or px value in this file — see agents.md R5 and §11.2 #13.
 */
